...
interface AuthContextType {
  ...
  users: User[]; // The full list of users is now available through the context
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // This state now serves as the single source of truth for user data.
  ...
  return (
    <AuthContext.Provider value={{ currentUser, currentAdmin, users, login, logout, register }}>
      {children}
